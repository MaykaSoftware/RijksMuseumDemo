package com.farid.rijksmuseumdemo.data.local
...
import com.farid.rijksmuseumdemo.data.mapper.toArtObjectEntity
...
class ArtObjectRemoteMediator @Inject constructor(
    ...
    override suspend fun load(
        ...
        try {
            val apiResponse = artObjectApi.getMuseumObjects(
                language = "nl",
                page = page,
